# -*- coding: utf-8 -*-
"""
Created on Sun May  8 20:35:01 2022
...
for i in A:
    for j in A:
        ...
        ann.add(tf.keras.layers.Dense(units=i,activation='relu'))   #hidden layer 1
        ann.add(tf.keras.layers.Dense(units=j,activation='relu'))   #hidden layer 2
